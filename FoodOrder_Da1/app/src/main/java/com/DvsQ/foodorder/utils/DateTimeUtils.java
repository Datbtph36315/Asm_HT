...
public class DateTimeUtils {
    ...
    // Định dạng ngày giờ mặc định (dd-MM-yyyy,hh:mm a)
    ...
    // Phương thức chuyển đổi timestamp sang chuỗi ngày giờ
    ...
    // Phương thức chuyển đổi timestamp sang chuỗi ngày (định dạng khác)
    ...
    // Phương thức chuyển đổi chuỗi ngày (định dạng khác) sang timestamp
