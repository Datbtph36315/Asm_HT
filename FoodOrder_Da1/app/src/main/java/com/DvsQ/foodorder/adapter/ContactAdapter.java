...
import com.DvsQ.foodorder.databinding.ItemContactBinding;
...
public class ContactAdapter extends RecyclerView.Adapter<ContactAdapter.ContactViewHolder> {
    ...
    // Giao diện để xử lý sự kiện khi người dùng click để gọi điện thoại
    ...
    public void onBindViewHolder(@NonNull ContactViewHolder holder, int position) {
        // Lấy dữ liệu liên hệ từ danh sách
        Contact contact = listContact.get(position);
        if (contact == null) {
            return;
        }

        // Thiết lập ảnh đại diện và loại liên hệ
        ...
        // Xử lý sự kiện khi người dùng click vào một liên hệ
